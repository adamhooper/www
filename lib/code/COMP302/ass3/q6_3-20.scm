; Signal an error if a closure is called with the wrong number of arguments
;
; This is a trivial question -- no idea why it's rated as two stars. Simply
; put a test inside apply-procval:
