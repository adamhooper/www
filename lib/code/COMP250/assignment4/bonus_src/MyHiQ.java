	...
	implements Comparable
{
	...
	public void print ()
	{
		...
		System.out.println (num_variations + " times:");
	...
	private void reorient ()
	{
		...
		for (i = 1; i < 8; i++)
		{
			/* remember number of permutations */
			alt_configs[i] = config & 0xfffffffe00000000L;
		}
	...
	public int compareTo (Object comp)
	{
		...
		c1 = config & 0x00000001ffffffffL;
		c2 = ((MyHiQ) comp).config & 0x00000001ffffffffL;
